...
td_group <- protein_data %>%
  ...
  mutate(TargetDetectability_value = ifelse(Target %in% c("APOE", "CRP"),
                                            abs(TargetDetectability_value),
                                            TargetDetectability_value))
...
detectability_summary = detectability_summary %>%
  mutate(n_samples = ifelse(SampleMatrixType == "CSF" & Target %in% c("CRP","APOE"),
                            NA,n_samples),
         n_below_lod = ifelse(SampleMatrixType == "CSF" & Target %in% c("CRP","APOE"),
                              NA,n_below_lod),
         frac_below_lod =  ifelse(SampleMatrixType == "CSF" & Target %in% c("CRP","APOE"),
                                  NA,frac_below_lod),
         percent_below_lod = ifelse(SampleMatrixType == "CSF" & Target %in% c("CRP","APOE"),
                                    NA,percent_below_lod),
         detectability = ifelse(SampleMatrixType == "CSF" & Target %in% c("CRP","APOE"),
                                NA,detectability))
